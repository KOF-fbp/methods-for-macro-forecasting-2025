...
- AR(1) + trend, Beta weighting for monthly KOF barometer
$$
...
## Data: variables, frequency, sample 

- Quarterly targets: GDP growth (annualised), CPI inflation (annualised), log CHF/EUR exchange rate
